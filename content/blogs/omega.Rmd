...
\`\`\`{r, hypothesis_testing_t\_test_sal_gender}
...
get_p\_value(obs_stat = obsv_diff,
...
shade_p\_value(obs_stat = obsv_diff,
...
\`\`\`{r, hypothesis_testing_t\_test_exp_gender}
...
get_p\_value(obs_stat = obsv_diff_exp,
...
shade_p\_value(obs_stat = obsv_diff_exp,
